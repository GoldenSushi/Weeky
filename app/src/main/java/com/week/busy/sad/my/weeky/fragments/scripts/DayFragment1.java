...
public class DayFragment1 extends Fragment {
    ...
    private static final String DISCIPLINE_FILE_NAME = "monday_data_discipline.myapp";
    private static final String ROOM_FILE_NAME = "monday_data_room.myapp";
    private static final String[] DATA_STRING_DISCIPLINE = DataStore.getDiscipline_list_monday();
    private static final String[] DATA_STRING_CLASSROOM = DataStore.getRoom_list_monday();

    private int pageNumber;


    private final int layout = R.layout.layout_day_fragment1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //restores the data from the text files (FILE_NAMEs) of this fragment
        DataStore.restore(
                getContext(),
        ...
        RecyclerView recycler = (RecyclerView) currentView.findViewById(R.id.recycler_v_fragment1);
    ...
    public static DayFragment1 createFragment(int position) {
