...
public class DayFragment7 extends Fragment {

    private static final String DISCIPLINE_FILE_NAME = "sunday_data_discipline.myapp";
    private static final String ROOM_FILE_NAME = "sunday_data_room.myapp";
    private static final String[] DATA_STRING_DISCIPLINE = DataStore.getDiscipline_list_sunday();
    private static final String[] DATA_STRING_CLASSROOM = DataStore.getRoom_list_sunday();

    private int pageNumber;


    private final int layout = R.layout.layout_day_fragment7;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recycler = (RecyclerView) currentView.findViewById(R.id.recycler_v_fragment7);
    ...
    public static DayFragment7 createFragment(int position) {
        DayFragment7 fragment = new DayFragment7();
