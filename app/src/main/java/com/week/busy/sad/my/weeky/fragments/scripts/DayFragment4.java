...
public class DayFragment4 extends Fragment {
    ...
    private static final String DISCIPLINE_FILE_NAME = "thursday_data_discipline.myapp";
    private static final String ROOM_FILE_NAME = "thursday_data_room.myapp";
    private static final String[] DATA_STRING_DISCIPLINE = DataStore.getDiscipline_list_thursday();
    private static final String[] DATA_STRING_CLASSROOM = DataStore.getRoom_list_thursday();

    private int pageNumber;


    private final int layout = R.layout.layout_day_fragment4;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recycler = (RecyclerView) currentView.findViewById(R.id.recycler_v_fragment4);
    ...
    public static DayFragment4 createFragment(int position) {
